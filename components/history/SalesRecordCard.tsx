  ...
  if (isSlim) {
    ...
    return (
      <tr className={`${rowBgClass} border-b ${borderClass}`}>
        ...
        <td 
          onClick={onClick}
          className={`py-2 px-1 border-r ${borderClass} align-middle text-center w-[95px] cursor-pointer transition-colors ${hoverBgClass}`}
        >
          {/* 時刻（下線付き、白文字） */}
        ...
        <td className="py-2 px-2 text-center align-middle w-[75px]">
